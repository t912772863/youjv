...
<body>
	...
	者只能用servlet来解决流文件-->
	"普通的表单提交方式"
	<form id="uploadForm" action="user_info/update_head_image" method="post" enctype="multipart/form-data">
        <input type="" name="uid" value="7">
		请选择上传的图片或文件:<input type="file" name="headImage" /> 文件名: &nbsp
